...
capture = cv2.VideoCapture("./media/regular.mp4")  # change to destination on your pc
i = 0
minArea = 1
while True:
    ...
    if moments['m00'] >= minArea:
        ...
        if x > 40 and x < 55 and y > 50 and y < 65:  # range of line coordinates for values on left lane
            i = i + 1
            print(i)
        elif x > 102 and x < 110 and y > 105 and y < 130:  # range of line coordinates for values on right lane
            i = i + 1
            print(i)
        print(x,y)
